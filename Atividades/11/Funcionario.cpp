...
Funcionario::Funcionario(string name, int matriculation, double salary, int monthlyWorkload, int hoursWorkedInMonth) : name(name), matriculation(matriculation), salary(salary), monthlyWorkload(monthlyWorkload), hoursWorkedInMonth(hoursWorkedInMonth)
{
